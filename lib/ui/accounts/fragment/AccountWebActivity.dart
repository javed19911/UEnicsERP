...
class _AccountWebActivityState
    extends BaseActivity<AccountWebActivity, vmAccount> {
  @override
  void onCreate() {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    border:
                        Border.all(color: CustomColors.graySofi(), width: 1.0)),
                child: Column(
                  children: [
                    UnderLineText(
  ...
  Widget getSubMenuWidget(Menu menu) {
    return Container(
      height: 40,
      color: Colors.white,
