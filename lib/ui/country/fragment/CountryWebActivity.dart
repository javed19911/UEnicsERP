...
class CountryWebActivity extends StatefulWidget {
  const CountryWebActivity({Key? key}) : super(key: key);

  @override
  _CountryWebActivityState createState() => _CountryWebActivityState();
}
